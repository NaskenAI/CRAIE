      ...
      <section className="bg-gradient-hero text-white py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 max-w-3xl mx-auto">
            Learn more about CRAIE&apos;s mission, vision, and the dedicated team
            working to advance responsible AI in education.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                To advance responsible and equitable adoption of artificial
                intelligence in education by providing training, resources, and
                volunteer support to schools and nonprofits, especially in
                underserved communities.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                We believe that artificial intelligence has the power to
                transform education for the better, but only when implemented
                thoughtfully, ethically, and with equity at the forefront. Our
                work focuses on ensuring that all students, regardless of their
                background or school resources, have access to the benefits of
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Meet the dedicated leaders guiding CRAIE&apos;s mission and
              strategic direction.
            </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-primary-foreground/80">99-4455282</p>
            </div>
          </div>
        </div>
      </section>
